...
async function separarPorIdade(pessoas) {
    return new Promise(resolve => {
        ...
        var pessoasIdadePar = []
        var pessoasIdadeImpar = []

        pessoas.forEach(pessoa => {
            if (isOdd(pessoa.idade)) {
                quantidadeImpar++
                pessoasIdadeImpar.push(pessoa.nome);
            } else {
                quantidadePar++
                pessoasIdadePar.push(pessoa.nome)
            }
        });

        resolve({
            IdadePar: quantidadePar,
            IdadeImpar: quantidadeImpar,
            quantidadePessoasIdadePar: pessoasIdadePar,
            quantidadePessoasIdadeImpar: pessoasIdadeImpar,
...
function isOdd(idade) { return idade % 2; }

separarPorIdade(pessoas).then((resposta) => {
    console.log('Quantidade de Pessoas Com a Idades Impar :')
    console.log(resposta.IdadeImpar);
    console.log('---------------------------------------------------------------------------------------------------------')
    console.log('Quantidade de Pessoas Com a Idades Par :')
    console.log(resposta.IdadePar);
    console.log('---------------------------------------------------------------------------------------------------------')
    console.log('Nome Das Pessoas Com a Idade Par :')
    console.log(resposta.quantidadePessoasIdadePar.sort());
    console.log('---------------------------------------------------------------------------------------------------------')
    console.log('Nome Das Pessoas Com a Idades Impar :')
    console.log(resposta.quantidadePessoasIdadeImpar.sort());
